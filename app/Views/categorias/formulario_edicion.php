...
<div class="container">
    ...
    <input type="hidden" id="id_cat" name="id_cat" value=<?php echo $data['id_categoria']; ?> >
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="nombre_cat" name="nombre_cat" aria-describedby="emailHelp" value="<?php echo $data['nom_categoria']; ?>">
        </div>
        <div class="mb-3">
            <label for="descripcion_cat" class="form-label">Descripción</label>
            <input type="text" class="form-control" id="descripcion_cat"  name="descripcion_cat"  value="<?php echo $data['desc_categoria']; ?>">
        </div>
